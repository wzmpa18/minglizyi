...
// ============================================================================
// 来源：基于开源库 astronomy-engine 2.1.19（MIT 协议，作者 Donald Cross）的天文计算，
//       星盘占星学换算层（宫位/相位/星座归属）为本项目自研实现。
// 协议：astronomy-engine 为 MIT，允许商用与闭源使用，需保留原许可证声明（见
...
/** 引擎数据版本（合规可追溯标识） */
export const ASTRO_ENGINE_VERSION = "astronomy-engine 2.1.19 (MIT)";
