    ...
    >
      ...
      >
        ...
        <Section index={3} title="信息存储与保护">
          ...
          <P>
            3.2 <strong>存储期限：</strong>您的个人信息将在您使用本平台服务期间持续保存。在您注销账号后，本平台将在合理期限内删除或匿名化处理您的个人信息，法律法规另有规定的除外。
          </P>
          <P>
        ...
        <Section index={5} title="用户信息管理权">
          ...
          <ul style={{ margin: "0 0 10px", padding: 0 }}>
            ...
            <Li>
              <strong>删除：</strong>您可删除您在平台内产生的排盘记录、收藏内容等数据。如需删除账号，请联系客服处理。
            </Li>
            <Li>
              <strong>撤回同意：</strong>您可随时通过关闭相关功能或退出登录的方式撤回对本平台处理个人信息的授权。撤回同意后，本平台将停止相应的信息处理活动，但不影响撤回前已进行的处理。
            </Li>
            <Li>
              <strong>账号注销：</strong>您有权注销您的账号。注销后，本平台将在合理期限内删除或匿名化处理您的个人信息。如需注销账号，请联系本平台客服。
            </Li>
            <Li>
