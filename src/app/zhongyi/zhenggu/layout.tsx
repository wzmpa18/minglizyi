...
export const metadata: Metadata = {
  title: "正骨专区——中华非遗正骨知识学习｜言道国学",
  description: "正骨专区：中华非遗正骨流派知识整理，含正骨手法原理、流派传承与知识点学习，内容仅供专业了解，正骨操作须由专业医师进行，请勿自行模仿，免费在线使用，内容整理自传统典籍，仅供文化学习参考。",
};
    ...
    <>
      ...
      <section data-seo-nav style={{ maxWidth: "420px", margin: "0 auto", padding: "12px 12px 64px", backgroundColor: "#f5f5f5" }}>
        <div style={{ background: "#fff", borderRadius: 16, padding: 16, boxShadow: "0 1px 4px rgba(74,43,112,.06)" }}>
          ...
          <p style={{ fontSize: 12, lineHeight: 1.9, color: "#6B5B80", margin: "0 0 8px" }}>正骨专区：中华非遗正骨流派知识整理，含正骨手法原理、流派传承与知识点学习，内容仅供专业了解，正骨操作须由专业医师进行，请勿自行模仿。</p>
